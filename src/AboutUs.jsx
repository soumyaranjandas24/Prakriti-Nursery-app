...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Prakriti Nursery, where green meets serenity!</p>
      <p className="about-us-content">
        At Prakriti Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
